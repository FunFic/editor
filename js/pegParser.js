    ...
    function peg$subclass(child, parent) {
      ...
      function peg$parse(input, options) {
        ...
        var peg$FAILED = {},
          ...
          peg$c231 = function (elements, elision) {
            return {
              type: "ArrayExpression",
              elements: elements.concat(optionalList(extractOptional(elision, 0)))
            };
          },
          peg$c232 = function (elision, element) {
            return optionalList(extractOptional(elision, 0)).concat(element);
          },
          peg$c233 = function (head, elision, element) {
            return optionalList(extractOptional(elision, 0)).concat(element);
          },
          peg$c234 = function (head, tail) {
            return Array.prototype.concat.apply(head, tail);
          },
          peg$c235 = function (commas) {
          ...
          peg$c350 = function (declarations) {
            return {
          ...
          peg$c359 = function (declarations, test, update, body) {
            return {
              type: "ForStatement",
              init: {
                type: "VariableDeclaration",
          ...
          peg$c360 = function (left, right, body) {
            return {
              type: "ForInStatement",
              left: left,
              right: right,
          ...
          peg$c361 = function (declarations, right, body) {
            return {
              type: "ForInStatement",
              left: {
                type: "VariableDeclaration",
